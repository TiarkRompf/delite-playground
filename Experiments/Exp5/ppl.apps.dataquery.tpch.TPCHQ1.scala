...
val x98 = new generated.scala.DeliteArrayAnon1519366225(x82,x83,x84,x85,x86,x87,x88,x89,x90,x91,x92,x93,x94,x95,x96,x97)
var x383_buf: generated.scala.DeliteArrayAnon1519366225 = x98
var x383_size: Int = 0
...
val x73 = x15(14)
val x74 = x15(15)
val x75 = new generated.scala.Anon1519366225(x17,x19,x21,x23,x25,x27,x29,x31,x33,x35,x47,x59,x71,x72,x73,x74)
val x76 = x383_buf
val x77 = x75
if (true) {
val x151 = x383_size
...
val x177 = new generated.scala.DeliteArrayAnon1519366225(x161,x162,x163,x164,x165,x166,x167,x168,x169,x170,x171,x172,x173,x174,x175,x176)
...
x10_stream.close();
var x76: generated.scala.DeliteArrayAnon1519366225 = x383_buf
...
val x280 = new generated.scala.DeliteArrayAnon1519366225(x264,x265,x266,x267,x268,x269,x270,x271,x272,x273,x274,x275,x276,x277,x278,x279)
val x312 = x76 = x280
x312
}
if (x263) {
